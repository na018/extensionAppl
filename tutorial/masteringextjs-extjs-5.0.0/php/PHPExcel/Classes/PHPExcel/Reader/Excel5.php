...
//					echo '<br />';
		...
		foreach ($this->_definedname as $definedName) {
			if ($definedName['isBuiltInName']) {
				...
				case pack('C', 0x06):
					// print area
					//	in connection, formula looks like this: Foo!$C$7:$J$66,Bar!$A$1:$IV$2
...
//			echo 'Type is ',$type,', ';
	...
	/**
	 * Reads a connection type of BIFF record. Does nothing except for moving stream pointer forward to next record.
	 */
	...
	private function _readXf()
	{
		...
		if (!$this->_readDataOnly) {
			...
			if (isset($this->_formats[$numberFormatIndex])) {
				...
				// we set the connection format code
